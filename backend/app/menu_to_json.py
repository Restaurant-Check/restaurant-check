...
examples = """
DO NOT PRINT SOMETHING LIKE THIS, THAT HAS NO FOOD ITEMS:\n
```json
{
    "defs": {
        "MenuCategory": {
...
prompt = PromptTemplate(
  template=menu_query,
  input_variables=["menu_text", "format_instructions", "examples"],
)
...
def process_menu_text(menu_text: str):
    ...
    try:
      result = chain.invoke({"menu_text": menu_text, "format_instructions": format_instructions, "examples": examples})
